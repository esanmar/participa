    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center" aria-modal="true" role="dialog">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md m-4 animated-section">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-neutral-dark-gray">{t('settingsTitle')}</h2>
          <button onClick={onClose} aria-label={t('settingsCloseAria')}>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center p-3 bg-neutral-light-gray rounded-md">
            <label htmlFor="newComplaint" className="font-medium text-neutral-dark-gray">{t('settingsNewComplaint')}</label>
          ...
          <div className="flex justify-between items-center p-3 bg-neutral-light-gray rounded-md">
            <label htmlFor="statusChange" className="font-medium text-neutral-dark-gray">{t('settingsStatusChange')}</label>
          ...
          <div className="flex justify-between items-center p-3 bg-neutral-light-gray rounded-md">
            <label htmlFor="slaBreach" className="font-medium text-neutral-dark-gray">{t('settingsSlaBreach')}</label>
