...
const translations: Record<string, Record<string, string>> = {
  es: {
    ...
    chatbotSubmitError: "Lo sentimos, hubo un error al enviar tu incidencia. Inténtalo más tarde.",
    ...
    settingsCloseAria: "Cerrar modal de ajustes",
    settingsNewComplaint: "Avisarme de nuevas incidencias",
    settingsStatusChange: "Avisarme de cambios de estado",
    settingsSlaBreach: "Avisarme de posibles incumplimientos de SLA",
    saveSettings: "Guardar ajustes",
    cancel: "Cancelar",
    downloadReportTitle: "Descargar informe de predicción",
    downloadSectionsLabel: "Selecciona las secciones a incluir:",
    downloadFormatLabel: "Elige el formato:",
    reportSectionRiskMetrics: "Métricas de riesgo",
    reportSectionCriticalAreas: "5 áreas críticas",
    reportSectionHeatmap: "Mapa de calor geoespacial",
    reportSectionDistribution: "Distribución esperada de incidencias",
    reportSectionRecommendations: "Recomendaciones accionables",
    pdfDocument: "Documento PDF",
    csvData: "Datos CSV",
    csvOnlyCriticalAreas: "El CSV solo incluye los datos de 'Áreas críticas'.",
    csvSelectCriticalAreas: "Selecciona 'Áreas críticas' para descargar en CSV.",
    download: "Descargar",
    imageProcessError: "No se pudo procesar la imagen. Prueba con otra.",
    analyzeUnknownError: "Ocurrió un error al analizar la imagen. Inténtalo de nuevo.",
    removePhoto: "Eliminar",
    uploadAFile: "Sube un archivo",
    orDragDrop: "o arrastra y suelta",
    uploadFormatsHint: "PNG, JPG o WEBP hasta 10 MB",
    aiAnalyzingImage: "La IA está analizando tu imagen...",
    retryAnalysis: "Reintentar análisis",
    nextStep: "Siguiente paso:",
    aiAssistIntro: "Deja que la IA te ayude a completar el formulario a partir de la foto.",
    analyzeWithAI: "Analizar con IA",
    reanalyzeWithAI: "Reanalizar con IA",
    aiFilledDetails: "La IA ha rellenado los datos. Revísalos.",
    complaintDetailsSection: "2. Detalles de la incidencia",
    contactInfoSection: "3. Tus datos de contacto",
    smsUpdatesNote: "Te enviaremos avisos por SMS a este número.",
    contactPlaceholder: "Ej.: 987654321",
    submitting: "Enviando...",
    submissionFailed: "No se pudo enviar. Inténtalo de nuevo.",
    trackStatusTitle: "Seguimiento de la incidencia",
    enterTicketId: "Introduce tu ID de incidencia",
    trackPlaceholder: "Ej.: TKT-12345",
    tracking: "Consultando...",
    track: "Consultar",
    assignedTo: "Asignada a",
    transparencyInsights: "Transparencia",
    estimatedResolution: "Res. estimada",
    inQueue: "En cola",
    deptWorkload: "Carga del departamento",
    detailsTab: "Detalles",
    ...
    updatePlaceholder: "Si la situación ha cambiado, añade un comentario...",
    uploadBefore: "Foto 'Antes'",
    uploadAfter: "Foto 'Después'",
    noBeforePhoto: "No se adjuntó foto de 'antes'.",
    noAfterPhoto: "Aún no hay foto de 'después'.",
    resolvedTitle: "Creemos que esta incidencia está resuelta.",
    rateExperience: "¡Ayúdanos a mejorar! Valora tu experiencia.",
    optionalFeedback: "Añade comentarios opcionales",
    afterPhotoOptional: "Subir foto de 'después' (opcional)",
    submitFeedback: "Enviar valoración y cerrar",
    reopenCta: "¿No estás conforme? Reabrir incidencia",
    thankYouFeedback: "¡Gracias por tu valoración!",
    yourRating: "Tu puntuación:",
    similarResolved: "Incidencias resueltas similares cerca",
    reopenTicketTitle: "Reabrir incidencia",
    reopenReasonLabel: "Motivo de la reapertura",
    reopenReasonPlaceholder: "Ej.: El bache sigue sin rellenar completamente y es peligroso.",
    reopenDescription: "Explica por qué no estás conforme con la resolución. Tu opinión es importante.",
    submitReopen: "Enviar y reabrir",
    recentComplaintsTitle: "Incidencias recientes",
    recentComplaintsSubtitle: "Explora las últimas incidencias creadas y consúltalas al instante.",
    viewComplaint: "Ver incidencia",
    trackingValidation: "Añade un motivo (al menos 10 caracteres).",
    reopenFailed: "No se pudo reabrir la incidencia. Inténtalo de nuevo.",
    commentValidation: "Escribe un comentario (mínimo 5 caracteres).",
    addUpdateFailed: "No se pudo añadir la actualización. Inténtalo de nuevo.",
    ratingValidation: "Selecciona una puntuación antes de enviar.",
    feedbackFailed: "No se pudo enviar la valoración. Inténtalo de nuevo.",
    trackingError: "No se pudo cargar la predicción. Inténtalo más tarde.",
    trackingDataError: "No se pudieron cargar los datos de la predicción. Inténtalo más tarde.",
    trackingSeasonalAdvisory: "Aviso estacional",
    nextTwoWeeks: "Próximas 2 semanas",
    nextMonth: "Próximo mes",
    seasonLabel: "Selecciona la temporada:",
    seasonNormal: "Normal",
    seasonMonsoon: "Época de lluvias",
    seasonSummer: "Verano",
    seasonWinter: "Invierno",
    selectSeason: "Selecciona la temporada",
    selectCriticalAreasCsv: "Selecciona 'Áreas críticas' para generar CSV.",
  },
  eu: {
    home: "Hasiera",
    ...
    chatbotSubmitError: "Barkatu, errore bat gertatu da kexa bidaltzean. Saiatu geroago.",
    ...
    settingsTitle: "Jakinarazpen hobespenak",
    settingsCloseAria: "Itxi ezarpenen modala",
    settingsNewComplaint: "Jakinarazi kexa berriak daudenean",
    settingsStatusChange: "Jakinarazi egoera aldatzen denean",
    settingsSlaBreach: "Jakinarazi SLA urraketak egon daitezkeenean",
    saveSettings: "Gorde ezarpenak",
    cancel: "Utzi",
    downloadReportTitle: "Deskargatu aurreikuspen txostena",
    downloadSectionsLabel: "Aukeratu sartu nahi dituzun atalak:",
    downloadFormatLabel: "Aukeratu formatua:",
    reportSectionRiskMetrics: "Arriskuaren neurriak",
    reportSectionCriticalAreas: "5 gune kritiko",
    reportSectionHeatmap: "Mapa geoespazialaren irudia",
    reportSectionDistribution: "Aurreikusitako banaketa",
    reportSectionRecommendations: "Gomendio eraginkorrak",
    pdfDocument: "PDF dokumentua",
    csvData: "CSV datuak",
    csvOnlyCriticalAreas: "CSVak 'Gune kritikoak' datuak soilik jasotzen ditu.",
    csvSelectCriticalAreas: "Aukeratu 'Gune kritikoak' CSV deskargatzeko.",
    download: "Deskargatu",
    imageProcessError: "Ezin izan da irudia prozesatu. Saiatu beste batekin.",
    analyzeUnknownError: "Errore bat gertatu da irudia aztertzean. Saiatu berriro.",
    removePhoto: "Ezabatu",
    uploadAFile: "Igo fitxategi bat",
    orDragDrop: "edo arrastatu eta jaregin",
    uploadFormatsHint: "PNG, JPG edo WEBP gehienez 10 MB",
    aiAnalyzingImage: "IA irudia aztertzen ari da...",
    retryAnalysis: "Saiatu analisia berriro",
    nextStep: "Hurrengo urratsa:",
    aiAssistIntro: "Utzi IAK formularioa betetzen lagun dezan argazkiaren arabera.",
    analyzeWithAI: "Aztertu IArekin",
    reanalyzeWithAI: "Aztertu berriro IArekin",
    aiFilledDetails: "IAk datuak bete ditu. Berrikusi mesedez.",
    complaintDetailsSection: "2. Gorabidearen xehetasunak",
    contactInfoSection: "3. Zure kontaktu-datuak",
    smsUpdatesNote: "SMS bidez bidaliko dizkizugu eguneratzeak zenbaki honetara.",
    contactPlaceholder: "Adib.: 987654321",
    submitting: "Bidaltzen...",
    submissionFailed: "Ezin izan da bidali. Saiatu berriro.",
    trackStatusTitle: "Gorabidearen jarraipena",
    enterTicketId: "Sartu zure gorabidearen IDa",
    trackPlaceholder: "Adib.: TKT-12345",
    tracking: "Kontsultatzen...",
    track: "Kontsultatu",
    assignedTo: "Nori esleitua",
    transparencyInsights: "Gardentasuna",
    estimatedResolution: "Balizko ebazpena",
    inQueue: "Ilaran",
    deptWorkload: "Sailaren lana",
    detailsTab: "Xehetasunak",
    evidenceTab: "Frogak",
    historyTab: "Historia",
    submittedOn: "Bidalia",
    locationLabel: "Kokapena",
    yourDescription: "Zure azalpena",
    addUpdate: "Gehitu eguneratzea",
    updatePlaceholder: "Egoerak aldatu badu, gehitu iruzkin bat...",
    uploadBefore: "'Aurretik' argazkia",
    uploadAfter: "'Ondoren' argazkia",
    noBeforePhoto: "Ez da 'aurretik' argazkirik erantsi.",
    noAfterPhoto: "Oraindik ez dago 'ondoren' argazkirik.",
    resolvedTitle: "Uste dugu gorabide hau konponduta dagoela.",
    rateExperience: "Lagundu hobetu! Baloratu zure esperientzia.",
    optionalFeedback: "Gehitu aukerako iruzkina",
    afterPhotoOptional: "Igo 'ondoren' argazkia (aukerakoa)",
    submitFeedback: "Bidali balorazioa eta itxi",
    reopenCta: "Ez zaude ados? Ireki berriro",
    thankYouFeedback: "Eskerrik asko zure balorazioagatik!",
    yourRating: "Zure puntuazioa:",
    similarResolved: "Gertuko konponketa antzekoak",
    reopenTicketTitle: "Ireki berriro gorabidea",
    reopenReasonLabel: "Berriro irekitzeko arrazoia",
    reopenReasonPlaceholder: "Adib.: Zuloa ez dago guztiz beteta eta arriskutsua da.",
    reopenDescription: "Esan zergatik ez zauden ados ebazpenarekin. Zure iritzia garrantzitsua da.",
    submitReopen: "Bidali eta ireki berriro",
    recentComplaintsTitle: "Azken kexak",
    recentComplaintsSubtitle: "Ikusi azken kexak eta kontsultatu xehetasunak unean bertan.",
    viewComplaint: "Kexa ikusi",
    trackingValidation: "Gehitu arrazoia (gutxienez 10 karaktere).",
    reopenFailed: "Ezin izan da gorabidea berriro ireki. Saiatu berriro.",
    commentValidation: "Idatzi iruzkin bat (gutxienez 5 karaktere).",
    addUpdateFailed: "Ezin izan da eguneraketa gehitu. Saiatu berriro.",
    ratingValidation: "Aukeratu puntuazioa bidali aurretik.",
    feedbackFailed: "Ezin izan da balorazioa bidali. Saiatu berriro.",
    trackingError: "Ezin izan da aurreikuspena kargatu. Saiatu geroago.",
    trackingDataError: "Ezin izan dira aurreikuspen datuak kargatu. Saiatu geroago.",
    trackingSeasonalAdvisory: "Sasoiaren abisua",
    nextTwoWeeks: "Hurrengo 2 asteak",
    nextMonth: "Hurrengo hilabetea",
    seasonLabel: "Aukeratu urtaroa:",
    seasonNormal: "Ohikoa",
    seasonMonsoon: "Euri sasoia",
    seasonSummer: "Uda",
    seasonWinter: "Negua",
    selectSeason: "Aukeratu urtaroa",
    selectCriticalAreasCsv: "Aukeratu 'Gune kritikoak' CSV sortzeko.",
  },
};
